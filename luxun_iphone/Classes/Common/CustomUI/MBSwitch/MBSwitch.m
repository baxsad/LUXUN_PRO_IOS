...
- (void) configure {
    ...
    _tintColor = [UIColor colorWithRed:1.0f green:1.0f blue:1.0f alpha:1.00f];
...
- (void)setOn:(BOOL)on animated:(BOOL)animated {
    ...
    if (animated) {
        ...
        _thumbLayer.fillColor = [[self getThumbTintColor:_on] CGColor];
    }else {
...
- (void) setOnThumbTintColor:(UIColor *)thumbTintColor {
    onThumbColor = thumbTintColor;
    _thumbLayer.fillColor = [[self getThumbTintColor:_on] CGColor];
}

- (void) setOffThumbTintColor:(UIColor *)thumbTintColor {
    offThumbColor = thumbTintColor;
    _thumbLayer.fillColor = [[self getThumbTintColor:_on] CGColor];
}
...
- (UIColor *)getThumbTintColor:(BOOL)on
{
    if (on) {
        if (onThumbColor) {
            return onThumbColor;
